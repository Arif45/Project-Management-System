...
class DepartmentsController extends Controller
{
    ...
    public function update(Request $request, Department $department)
    {
        ...
        if($departmentUpdate){
            ...
            return redirect()->route('departments.show', ['department'=>$department->id])->with('success', 'Department updated successfully');
        }
    ...
    public function destroy(Department $department)
    {
        ...
        return back()->withInput()->with('error' , 'Department could not be deletd');
    }
}
